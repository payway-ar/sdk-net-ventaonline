...
namespace Decidir
{
    ...
    {
        #region Constants
        public const string versionDecidir = "1.0.0";
        
        private const string endPointSandbox = "https://developers.decidir.com/api/v1/";

        private const string endPointProduction = "https://live.decidir.com/api/v1/";
        #endregion
